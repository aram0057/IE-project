...
# Load YOLO and classification models once when the view module is loaded
yolo_model = torch.hub.load('ultralytics/yolov5', 'yolov5m')
classification_model = load_model(os.path.join(BASE_DIR, 'myapp', 'waste_classification_model.h5'))
...
def upload_file(request):
    if request.method == 'POST' and 'uploaded_file' in request.FILES:
        ...
        # Process the image with YOLO and classification model
